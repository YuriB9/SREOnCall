...
- [ ] 5.1 Ручная проверка: сбросить Redis (`FLUSHALL`/рестарт контейнера), запустить scheduling, отправить вебхук ingestion с ранее выданным токеном — ожидать HTTP 200, а не 401
